...
Yes, there is a new accounting database client/server example available right 
[here](http://liveprojects.derrickfarris.com/ "Live Projects") on my website.
The project is a display of a **pure Javascript** (yep, no jQuery here) client and a Node.js/Express backend.
